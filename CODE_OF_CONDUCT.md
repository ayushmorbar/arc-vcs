...
arc is a community that believes version control systems can be
mathematically rigorous, openly designed, and welcoming to all.
...
5. Gracefully giving and accepting **constructive feedback**, commenting
   on ideas rather than people.
6. Committing to **repairing harm** when it occurs.
7. Evaluating technical contributions **solely on their technical merit**,
   setting aside unrelated personal, social, or demographic factors.
...
7. **Merit-unrelated dismissal.** Dismissing or rejecting technical
   contributions on grounds unrelated to their technical merit.
8. Behaving in other ways that **threaten the well-being** of our
   community.
...
2. **Failing to credit sources.** Not properly crediting the sources of
   code, documentation, or other content you contribute.
...
report a possible violation, use **GitHub's private vulnerability/conduct
reporting feature** on the repository, or contact the maintainers directly
via the email addresses listed in `Cargo.toml`. If a maintainer is the
subject of the report, you may contact any other listed maintainer
individually.

Community Moderators (the project maintainers) take reports of violations
seriously and will make every effort to respond in a timely manner. They
will investigate all reports of code of conduct violations, reviewing
messages, logs, and relevant records, or interviewing witnesses and other
participants. Community Moderators will keep investigation and enforcement
actions as transparent as possible while prioritizing safety and
confidentiality. Enforcement actions are carried out in private with the
involved parties, but communicating to the whole community may be part of
...
1. **Warning**
   ...
   - *Consequence:* A private, written warning from the Community
     Moderators.
   - *Repair:* Examples include a private written apology,
     acknowledgement of responsibility, and seeking clarification on
     expectations.

2. **Temporarily Limited Activities**
   - *Event:* A repeated incidence of a violation that previously resulted
     in a warning, or the first incidence of a more serious violation.
   - *Consequence:* A private, written warning with a time-limited
     cooldown period. The cooldown may be limited to particular community
     channels (e.g., Issues, Discussions) or interactions with particular
     community members.
   - *Repair:* Examples include making an apology, using the cooldown
     period to reflect on actions and impact, and being thoughtful about
     re-entering community spaces.
...
3. **Temporary Suspension**
   ...
   - *Consequence:* A private written warning with conditions for return
     from suspension. Temporary suspensions give the person time to
   ...
   - *Repair:* Examples include respecting the spirit of the suspension,
     meeting the specified conditions for return, and being thoughtful
     about how to reintegrate with the community.
...
4. **Permanent Ban**
   ...
   - *Consequence:* Access to all community spaces (GitHub Issues, Pull
     Requests, Discussions, and related channels) is removed. Permanent
     bans should be rarely used and only resorted to if working through
...
GitHub Issues, Pull Requests, Discussions, and any other communication
channels used by the arc project — and also applies when an individual is
officially representing the community in public or other spaces. Examples
of representing our community include using an official email address,
...
https://www.contributor-covenant.org/faq. Additional enforcement and
