...
2. **An Architecture Decision Record (ADR)** — document the decision in `docs/src/architecture/ADRs/` following the template in existing ADRs. Reference the ADR in the merge commit.
...
2. Copy `docs/src/architecture/ADRs/001-blake3-cas.md` as a template.
