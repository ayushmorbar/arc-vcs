---
title: "Patch Theory"
description: "Conceptual foundations of arc atom algebra, commutativity, and DAG reconstruction."
---
...
The `commute` module in `arc-algebra` implements this decision procedure. When commutativity fails, a `ConflictError` is returned and the AI resolver is invoked.
